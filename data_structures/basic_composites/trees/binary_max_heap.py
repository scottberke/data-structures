...
class MaxHeap(list):
    ...
    def bubble_up(self):
        ...
        in the heap. Checks if a parent node is smaller than the node in question
    ...
    def bubble_down(self):
        ...
        during an operation like poll(). Checks if a parent node is smaller than
        ...
        while True:
            ...
            if len(children) == 2:
                if self[children[0]] == self[children[1]]:
                    ...
                    swap_node = children[0] if self[children[0]] > self[children[1]] else children[1]
            else:
                swap_node = children[0] if self[children[0]] > self[children[1]] else children[1]
